        ...
        try{        
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                    ...
                    PreparedStatement preparedStatement = c1.prepareStatement("Insert into bank values(?,?,?,?,?)");
                    preparedStatement.setString(1, b);
                    preparedStatement.setDouble(2, Double.parseDouble(a));
                    preparedStatement.setDouble(3, 0);
                    preparedStatement.setDouble(4, Double.parseDouble(a));
